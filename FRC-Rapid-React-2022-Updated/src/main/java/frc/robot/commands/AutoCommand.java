...
public class AutoCommand extends SequentialCommandGroup {
    ...
    public AutoCommand(MecanumSystem mecanumSystem, FlyWheel flyWheelSystem, LinearActuator linearActuatorSystem){
        ...
        addCommands(new AutoDrive(m_mecanum, -0.2, 0, 0).withTimeout(3));
        addCommands(new StartEndCommand(new ParallelCommandGroup(new ActivateFlyWheel(1.0, m_flyWheel), new ActivateLinearActuator(1.0, m_linearActuator)).withTimeout(3), new ActivateLinearActuator(-1.0, m_linearActuator),));
