...
public class MecanumSystem extends SubsystemBase{
    ...
    //motors for mecanum
    private static WPI_TalonSRX frontRightWheel = new WPI_TalonSRX(7);
    private static WPI_TalonSRX frontLeftWheel = new WPI_TalonSRX(4);
    private static WPI_TalonSRX backRightWheel = new WPI_TalonSRX(3);
    private static WPI_TalonSRX backLeftWheel = new WPI_TalonSRX(6);
